...
def extract_bibliography_sections(html_content):
    ...
    section_headers = [
        'Bibliography', 'Sources', 'Further Reading', 'References',
        'bibliography', 'sources', 'further reading', 'references'
    ]
...
def extract_book_citations(html_content):
    ...
    citation_selectors = [
        'ol li', 'ul li', '.reflist li', '.references li',
        '#References li', '#Bibliography li', '#Sources li', '#Further_Reading li'
    ]
    ...
    for selector in citation_selectors:
        ...
        for element in elements:
            ...
            if re.search(r'ISBN[-\s]?\d+[-\s]?\d+[-\s]?\d+[-\s]?\d+[-\s]?\d+', text, re.IGNORECASE):
